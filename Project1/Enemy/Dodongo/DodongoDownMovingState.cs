...
{
    public class DodongoDownMovingState : IEnemyState
    {
        ...
        public DodongoDownMovingState(IEnemy dodongo)
        {
            this.dodongo = dodongo;
            dodongo.Sprite = SpriteFactory.Instance.CreateSprite("Dodongo_walking_down");
